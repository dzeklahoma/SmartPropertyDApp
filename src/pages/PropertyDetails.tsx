...
const PropertyDetails: React.FC = () => {
  ...
  const { web3, account, propertyFactoryContract, getPropertyContract } =
    useWeb3();
  ...
  const fetchPropertyDetails = async (id: number) => {
    try {
      ...
      const propertyAddress: string = await propertyFactoryContract.methods
        .getPropertyById(id)
        .call();
                        ...
                        <div className="mt-1 text-sm">
                          ...
                          {tx.type === "LISTED" && (
                            <p className="text-gray-600">
                              Listed for{" "}
                              <span className="font-medium">
                                {web3?.utils.fromWei(tx.price || "0", "ether")}{" "}
                                ETH
                              </span>
                            </p>
                          )}
